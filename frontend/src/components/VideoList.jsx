...
import { Card, Button, Row, Col, ListGroup, Modal, Spinner } from 'react-bootstrap';
import { FaTrashAlt, FaPlayCircle, FaCheckCircle } from 'react-icons/fa';
                        ...
                        <ListGroup horizontal className="justify-content-between">
                          <ListGroup.Item className="d-flex align-items-center">
                            {video.processed ? (
                                ...
                                <FaPlayCircle className="mr-2" onClick={() => handleStartProcessing(video.slug)}/>
                            )}
                            Processed
                          </ListGroup.Item>
